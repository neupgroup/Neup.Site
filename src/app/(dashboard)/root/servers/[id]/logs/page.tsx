  ...
  return (
    <div className="w-full space-y-6">
        <div className="flex items-center justify-between">
            <div>
                <h1 className="font-headline text-2xl font-semibold tracking-tight">Server Logs</h1>
                <p className="text-muted-foreground">History of all commands run on this server.</p>
            </div>
