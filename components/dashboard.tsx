...
import { Collapsible, CollapsibleContent, CollapsibleTrigger } from '@neup/components/ui/collapsible';
import { Button } from '@neup/components/ui/button';
import { NavLink as SidebarNavLink } from '@neup/components/ui/nav-link';
import { Sidebar } from '@neup/components/ui/sidebar';
  ...
  return (
    <nav className="flex w-full flex-col items-stretch gap-2">
      ...
      <div className="mt-4 space-y-2">
        ...
        <SidebarNavItem href="/modules" currentPath={currentPath} project={project} onClick={onLinkClick}><Puzzle className="h-4 w-4" /><span>Modules</span></SidebarNavItem>
